...
import HenryTGZJMod.powers.BloodOfSiegfriedPower;
...
public class BloodOfSiegfried extends AbstractHenryCard {
    public static final String ID = ModHelper.makePath(BloodOfSiegfried.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster m) { //卡牌使用效果
        this.addToBot(new ApplyPowerAction(p, p, new BloodOfSiegfriedPower(p, magicNumber), magicNumber));
    }
}