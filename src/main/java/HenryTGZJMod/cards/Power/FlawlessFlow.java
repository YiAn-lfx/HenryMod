...
import HenryTGZJMod.powers.FlawlessFlowPower;
...
public class FlawlessFlow extends AbstractHenryCard {
    public static final String ID = ModHelper.makePath(FlawlessFlow.class.getSimpleName());
