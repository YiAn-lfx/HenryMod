...
import HenryTGZJMod.powers.FollowThroughPower;
...
public class FollowThrough extends AbstractHenryCard {
    public static final String ID = ModHelper.makePath(FollowThrough.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster m) { //卡牌使用效果
        this.addToBot(
                new ApplyPowerAction(
                        p, p, new FollowThroughPower(p,1)
                )
        );
    }
}