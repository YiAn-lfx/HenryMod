...
import HenryTGZJMod.powers.CreepingPhantomPower;
...
public class CreepingPhantom extends AbstractHenryCard {
    public static final String ID = ModHelper.makePath(CreepingPhantom.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster m) { //卡牌使用效果
        this.addToBot(new ApplyPowerAction(p, p, new CreepingPhantomPower(p, magicNumber), magicNumber));
    }
