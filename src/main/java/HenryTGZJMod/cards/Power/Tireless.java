...
import HenryTGZJMod.powers.TirelessPower;
...
public class Tireless extends AbstractHenryCard {
    public static final String ID = ModHelper.makePath(Tireless.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster m) { //卡牌使用效果
        this.addToBot(
                new ApplyPowerAction(
                        p, p, new TirelessPower(p, magicNumber)
                )
        );
    }
}