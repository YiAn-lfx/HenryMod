...
import HenryTGZJMod.powers.InitiativePower;
...
public class Initiative extends AbstractHenryCard {
    public static final String ID = ModHelper.makePath(Initiative.class.getSimpleName());
