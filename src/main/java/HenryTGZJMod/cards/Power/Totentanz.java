...
public class Totentanz extends AbstractHenryCard {
    public static final String ID = ModHelper.makePath(Totentanz.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster m) { //卡牌使用效果
        this.addToBot(new ApplyPowerAction(p, p, new TotentanzPower(p, magicNumber), magicNumber));
    }
}