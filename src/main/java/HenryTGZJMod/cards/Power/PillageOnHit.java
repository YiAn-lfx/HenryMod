...
import HenryTGZJMod.powers.TwoForOnePower;
...
public class PillageOnHit extends AbstractHenryCard {
    public static final String ID = ModHelper.makePath(PillageOnHit.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster m) { //卡牌使用效果
        this.addToBot(new ApplyPowerAction(p, p, new PillageOnHitPower(p,magicNumber), magicNumber));
    }
}