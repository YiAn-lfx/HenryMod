...
public class LowerRightStrike extends AbstractHenryCard {
    public static final String ID = ModHelper.makePath(LowerRightStrike.class.getSimpleName());
