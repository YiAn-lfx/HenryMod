...
public class PreemptiveAttack extends AbstractHenryCard {
    public static final String ID = ModHelper.makePath(PreemptiveAttack.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster m) { //卡牌使用效果
        this.addToBot(new BetterDrawPileToHandAction(2));
    }
}