...
import HenryTGZJMod.actions.BreakAndRebuildAction;
...
public class BreakAndRebuild extends AbstractHenryCard {
    public static final String ID = ModHelper.makePath(BreakAndRebuild.class.getSimpleName());
