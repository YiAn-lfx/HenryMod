...
public class FollowThroughPower extends AbstractHenryPower {
    public static final String POWER_ID = ModHelper.makePath(FollowThroughPower.class.getSimpleName()); // 能力的ID
    ...
    public FollowThroughPower(AbstractCreature owner, int Amount) {
        this.name = NAME;
        this.ID = POWER_ID;
        this.owner = owner;
