...
public class TirelessPower extends AbstractHenryPower {
    public static final String POWER_ID = ModHelper.makePath(TirelessPower.class.getSimpleName()); // 能力的ID
    ...
    public TirelessPower(AbstractCreature owner, int Amount) {
        this.name = NAME;
        this.ID = POWER_ID;
        this.owner = owner;
