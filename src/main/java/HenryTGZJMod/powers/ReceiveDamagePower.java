...
public class ReceiveDamagePower extends AbstractHenryPower implements InvisiblePower {
    public static final String POWER_ID = ModHelper.makePath(ReceiveDamagePower.class.getSimpleName()); // 能力的ID
    ...
    public ReceiveDamagePower(AbstractCreature owner, int Amount) {
        this.name = NAME;
        this.ID = POWER_ID;
        this.owner = owner;
