...
public class DictateTheTempoPower extends AbstractHenryPower {
    public static final String POWER_ID = ModHelper.makePath(DictateTheTempoPower.class.getSimpleName()); // 能力的ID
    ...
    public DictateTheTempoPower(AbstractCreature owner, int Amount) {
        this.name = NAME;
        this.ID = POWER_ID;
        this.owner = owner;
