...
public class TotentanzPower extends AbstractHenryPower {
    public static final String POWER_ID = ModHelper.makePath(TotentanzPower.class.getSimpleName()); // 能力的ID
    ...
    public TotentanzPower(AbstractCreature owner, int Amount) {
        this.name = NAME;
        this.ID = POWER_ID;
        this.owner = owner;
