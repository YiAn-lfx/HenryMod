...
public class SecretOfMatterPower extends AbstractHenryPower {
    public static final String POWER_ID = ModHelper.makePath(SecretOfMatterPower.class.getSimpleName()); // 能力的ID
    ...
    public SecretOfMatterPower(AbstractCreature owner, int Amount) {
        this.name = NAME;
        this.ID = POWER_ID;
        this.owner = owner;
