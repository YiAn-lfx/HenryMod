...
public class BloodOfSiegfriedPower extends AbstractHenryPower {
    public static final String POWER_ID = ModHelper.makePath(BloodOfSiegfriedPower.class.getSimpleName()); // 能力的ID
    ...
    public BloodOfSiegfriedPower(AbstractCreature owner, int Amount) {
        this.name = NAME;
        this.ID = POWER_ID;
        this.owner = owner;
