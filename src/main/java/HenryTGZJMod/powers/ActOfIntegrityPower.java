...
public class ActOfIntegrityPower extends AbstractHenryPower {
    public static final String POWER_ID = ModHelper.makePath(ActOfIntegrityPower.class.getSimpleName()); // 能力的ID
    ...
    public ActOfIntegrityPower(AbstractCreature owner, int Amount) {
        this.name = NAME;
        this.ID = POWER_ID;
        this.owner = owner;
