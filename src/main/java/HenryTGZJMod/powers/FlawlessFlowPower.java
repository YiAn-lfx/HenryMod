...
public class FlawlessFlowPower extends AbstractHenryPower {
    public static final String POWER_ID = ModHelper.makePath(FlawlessFlowPower.class.getSimpleName()); // 能力的ID
    ...
    public FlawlessFlowPower(AbstractCreature owner) {
        this.name = NAME;
        this.ID = POWER_ID;
        this.owner = owner;
