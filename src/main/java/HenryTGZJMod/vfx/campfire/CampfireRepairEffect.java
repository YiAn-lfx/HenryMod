...
public class CampfireRepairEffect extends AbstractGameEffect {
    ...
    public void update() {
        ...
        if (this.duration < 1.0F && !this.hasRepaired) {
            ...
            if (AbstractDungeon.player.hasRelic("HenryTGZJMod:PlateArmorStatus")) {
                AbstractDungeon.player.getRelic("HenryTGZJMod:PlateArmorStatus").flash();
                AbstractDungeon.player.getRelic("HenryTGZJMod:PlateArmorStatus").counter = 120;
